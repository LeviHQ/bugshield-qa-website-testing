      ...
      <div className="grid md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
            ...
            <a href="https://wa.me/919235943357?text=Hi%2C%20I%20have%20a%20query%20about%20your%20QA%20testing%20services." target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors flex items-center gap-2">
