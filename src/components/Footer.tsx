import { Shield, Mail, Linkedin, MessageCircle } from "lucide-react";
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
            ...
            <a href="https://wa.me/919235943357" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors flex items-center gap-2">
